...
<div class="d-flex flex-wrap gap-2 export-bar">
    <a class="btn btn-export-pdf btn-sm" href="<?= htmlspecialchars($pdfUrl, ENT_QUOTES, 'UTF-8') ?>">
        <i class="bi bi-file-earmark-pdf"></i> PDF
    </a>
    <a class="btn btn-export-xlsx btn-sm" href="<?= htmlspecialchars($xlsxUrl, ENT_QUOTES, 'UTF-8') ?>">
