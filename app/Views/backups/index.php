                            ...
                            <?php foreach ($files as $file): ?>
                                <tr>
                                    ...
                                    <td class="text-end text-nowrap">
                                        <?php if ($isAdmin): ?>
                                            <a class="btn btn-sm btn-outline" href="<?= htmlspecialchars($url('backups/download?file=' . rawurlencode($file['filename'])), ENT_QUOTES, 'UTF-8') ?>">
