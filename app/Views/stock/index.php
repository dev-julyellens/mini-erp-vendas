...
$subtitle = 'Histórico rastreável; o saldo em produtos é atualizado automaticamente';
$actionsHtml = '';
if ($canCreate)
{
    $actionsHtml = '<a class="btn btn-primary" href="' . htmlspecialchars($url('stock-movements/create'), ENT_QUOTES, 'UTF-8') . '">'
        . '<i class="bi bi-plus-lg"></i> Nova movimentação</a>';
}
...
$filterAction = $url('stock-movements');
$filterClearHref = $url('stock-movements');
