...
-- LGPD e segurança (migration 015)
...
CREATE INDEX IF NOT EXISTS idx_pix_charges_company_id ON pix_charges (company_id);
CREATE INDEX IF NOT EXISTS idx_pix_charges_accounts_receivable_id ON pix_charges (accounts_receivable_id);
CREATE INDEX IF NOT EXISTS idx_pix_charges_installment_id ON pix_charges (installment_id)
